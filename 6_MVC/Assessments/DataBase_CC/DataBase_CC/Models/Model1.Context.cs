...
namespace DataBase_CC.Models
{
    ...
    public partial class northwindEntities : DbContext
    {
        ...
        [DbFunction("northwindEntities", "fn_Getdetailsbycountry")]
        public virtual IQueryable<fn_Getdetailsbycountry_Result> fn_Getdetailsbycountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_Getdetailsbycountry_Result>("[northwindEntities].[fn_Getdetailsbycountry](@country)", countryParameter);
        }
        ...
        public virtual ObjectResult<string> sp_getDescription(Nullable<int> rid)
        {
            var ridParameter = rid.HasValue ?
                new ObjectParameter("rid", rid) :
                new ObjectParameter("rid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("sp_getDescription", ridParameter);
        }
