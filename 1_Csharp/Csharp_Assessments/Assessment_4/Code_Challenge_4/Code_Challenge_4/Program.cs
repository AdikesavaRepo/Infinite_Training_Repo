...
namespace Code_Challenge_4
{
    ...
    class Program2
    {
        public static void Display2()
        {
            try
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("Please use only '+' or '-' or '*' operations only");
                    }
                }
            ...
            {
                Console.WriteLine("Input is not in correct format, Format Exception occurred:");
    ...
    class EmployeeDetails
    {
            ...
            List<Employee> empList = new List<Employee>
        {
            ...
            //3) Display details of all the employees whose title is AsstManager
            ...
            //4) Display details of all the employees whose Last Name starts with S

            var lastNameStartsWithS =
            from emp in empList
