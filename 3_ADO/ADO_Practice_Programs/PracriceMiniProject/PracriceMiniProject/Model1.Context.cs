...
namespace PracriceMiniProject
{
    ...
    public partial class PracticeProject1Entities : DbContext
    {
        public PracticeProject1Entities()
            : base("name=PracticeProject1Entities")
        {
        }
        ...
        public virtual ObjectResult<AddTrain_Result> AddTrain(Nullable<int> train_No, string train_Name, string source_Station, string destination_Station)
        {
            var train_NoParameter = train_No.HasValue ?
                new ObjectParameter("Train_No", train_No) :
                new ObjectParameter("Train_No", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AddTrain_Result>("AddTrain", train_NoParameter, train_NameParameter, source_StationParameter, destination_StationParameter);
        }
    
        public virtual ObjectResult<BookTrain_Ticket_Result> BookTrain_Ticket(Nullable<int> train_No, string passenger_Name, string class_Name, Nullable<System.DateTime> travel_Date, Nullable<int> tickets_Count)
        {
            var train_NoParameter = train_No.HasValue ?
                new ObjectParameter("Train_No", train_No) :
                new ObjectParameter("Train_No", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BookTrain_Ticket_Result>("BookTrain_Ticket", train_NoParameter, passenger_NameParameter, class_NameParameter, travel_DateParameter, tickets_CountParameter);
        }
        ...
        public virtual ObjectResult<Display_Trains_Result> Display_Trains()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Display_Trains_Result>("Display_Trains");
        }
