...
namespace Mini
{
    class Program
    {
        static PracticeProject1Entities db = new PracticeProject1Entities();
        ...
        public static void BookingTicket()
        {
            try
            {
                ...
                var parameters = new[]
                {
            new SqlParameter("@Train_No", Train_No),
            new SqlParameter("@Passenger_Name", Passenger_Name),
            new SqlParameter("@Class_Name", Class_Name),
            new SqlParameter("@Travel_Date", Travel_Date),
            new SqlParameter("@Tickets_Count", Tickets_Count),
            new SqlParameter
            {
                ...
                db.Database.ExecuteSqlCommand(
                    "EXEC BookTrain_Ticket @Train_No, @Passenger_Name, @Class_Name, @Travel_Date, @Tickets_Count, @ErrorMessage OUTPUT",
                    parameters
                );

                // Retrieve the output parameter value
                string errorMessage = (string)parameters.Last().Value;
